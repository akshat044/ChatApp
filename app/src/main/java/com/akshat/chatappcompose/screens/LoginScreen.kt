package com.akshat.chatappcompose.screens
...
import com.akshat.chatappcompose.R
...
fun LoginScreen(navController: NavHostController, vm: LCViewModel) {
    ...
    Box(
        ...
        Column(
            ...
            Button(onClick = {
                             vm.login(email = emailState.value.text, password = passwordState.value.text,context)
            },
